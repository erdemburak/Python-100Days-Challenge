...
def next_card():
    ...
    current_card["Italian"]
    canvas.itemconfig(card_title, text="Italian", fill="gray")
    canvas.itemconfig(card_word, text=current_card["Italian"], fill="gray")
...
card_title = canvas.create_text(400, 150, text="", font=("Ariel", 40, "italic"), fill="gray")
card_word = canvas.create_text(400, 263, text="", font=("Ariel", 60, "bold"), fill="gray")
