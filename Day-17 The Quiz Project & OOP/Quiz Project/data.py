"""
Docstring for Day-17 The Quiz Project & OOP.Quiz Project.data
To generate new questions i can *** Open Trivia DB ***
To be able to use new data set we just need to adjust its key value pears to our code 
"""
